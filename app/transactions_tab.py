...
from app.user_data_manager import load_user_data, retrain_user_model, save_user_data
...
def render_transactions_tab(user_id):
    ...
    edited_df = st.data_editor(
        st.session_state[data_key], num_rows="dynamic", use_container_width=True, key="editor_table"
    )
